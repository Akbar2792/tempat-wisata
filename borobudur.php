...
<html lang="en">
    <head>
        ...
        <title>Detail Candi Borobudur</title>
        <link
    ...
    <body class="bg-info bg-opacity-25">
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col col-8 shadow bg-white bg-opacity-25">
                    <iframe width="100%" height="700px" src="https://www.youtube.com/embed/IVIGEGsNB_8" title="Candi Borobudur (Cinematic Video)" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    <h3 class="mt-4 mb-2">Candi Borobudur</h3>
                    ...
                    <table class="table table-primary table-striped-columns text-center my-4">
                        <tr>
                            <td>Jam Buka</td>
                            <td>Jam Tutup</td>
                        </tr>
                    ...
                    <a class="btn btn-primary" href="order.php">Pesan Tiket</a><br><br>
                    </div>
                </div>
            </div>
        </div>
